...
public class PageDeposito extends PageObject{
    ...
    public void seleccionarTerminosCondiciones(){
        pageObjectUtil.clickElementByJavascript(getDriver(), xpathDepositoTarjeta.Xpath_CheckTerminoCondiciones);
        utilDef.esperarSegundos(10);
    }
    public void seleccionarBotonSiguiente(){
        pageObjectUtil.seleniumClick(getDriver(),xpathDepositoTarjeta.Xpath_Siguiente,0);
    }
