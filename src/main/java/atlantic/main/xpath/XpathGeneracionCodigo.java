...
public class XpathGeneracionCodigo {
    ...
    public final String Xpath_btnDepositar="//button[contains(text(), 'DEPOSITAR')]";//body/div[6]/div[2]/div[1]/div[2]/div[1]/div[1]/button[1]";//*[@id='main-header']/div[2]/div[1]/div[1]/button";
